...
- 1.1.3 좌측 상단에 위치한 `[서브넷]`를 클릭 후 `[서브넷 생성]`을 클릭하고 다음 정보를 입력 (총 6개의 서브넷 생성)
    - `[서브넷 이름:]` : **testVPC-public-subnet-2a** 
    - `[VPC:]` : **testVPC** 
    - `[가용 영역:*]` : **ap-northeast-2a** 
    - `[IPv4 CIDR:*]` : **10.0.0.0/24**
    
    - `[서브넷 이름:]` : **testVPC-public-subnet-2c** 
    - `[VPC:]` : **testVPC** 
    - `[가용 영역:*]` : **ap-northeast-2c** 
    - `[IPv4 CIDR:*]` : **10.0.1.0/24**
    
    - `[서브넷 이름:]` : **testVPC-private-subnet-2a** 
    - `[VPC:]` : **testVPC** 
    - `[가용 영역:*]` : **ap-northeast-2a** 
    - `[IPv4 CIDR:*]` : **10.0.2.0/24**
    
    - `[서브넷 이름:]` : **testVPC-private-subnet-2c** 
    - `[VPC:]` : **testVPC** 
    - `[가용 영역:*]` : **ap-northeast-2c** 
    - `[IPv4 CIDR:*]` : **10.0.3.0/24**
    
    - `[서브넷 이름:]` : **testVPC-rds-subnet-2a** 
    - `[VPC:]` : **testVPC** 
    - `[가용 영역:*]` : **ap-northeast-2a** 
    - `[IPv4 CIDR:*]` : **10.0.4.0/24**
    
    - `[서브넷 이름:]` : **testVPC-rds-subnet-2c** 
    - `[VPC:]` : **testVPC** 
    - `[가용 영역:*]` : **ap-northeast-2c** 
    - `[IPv4 CIDR:*]` : **10.0.5.0/24**
<br>

### Task 1.2 : 서브넷 연결 및 라우팅 테이블 구성
설명
